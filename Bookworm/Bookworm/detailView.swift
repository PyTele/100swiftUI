...
//  Bookworm
//
//  Created by Hubert Leszkiewicz on 13/02/2021.
//
import CoreData
import SwiftUI
...
struct detailView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        book.title = "Darling in the franxx: vol 1"
        book.author = "Kentaro Yabuki"
        book.genre = "Romance"
        book.rating = 5
        book.review = "You're breathtaking, no you're breathtaking - Kinu rivé"
